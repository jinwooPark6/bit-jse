...
// 1/1000 초 단위로 계산한다.
// 그것을 기반으로 해서 여러가지 값으로 보내주거나
// 아니면 우리가 DateFormat이란 것을 사용하여
// 우리가 원하는 형식으로 출력해 줄 수도 있다!
public class Ex04Calendar {
    public static void main(String[] args) {
        ...
        //시: 12시간은 h 24시간은 H
        //분: m
        //초: s를 사용하여 우리가 직접 지정해준다.
        
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy년 MM월 dd일 HH시 mm분 ss초");
        
        //DateFormat의 경우 1/1000 초 단위를
        //우리가 지정한 양식으로 이쁘게 String으로 바꿔주는 역할도 있지만
        //우리가 입력한 String이 지정한 양식과 일치하면
        //1/1000초로 바꾸는 역할도 한다.
        ...
        //sdf 객체를 이용하여 Calendar객체를 만들어보기
        ...
        //단 시간이 잘못되었거나 바꿀 수 없는 경우가 존재하기 때문에
