...
public class Ex02String {
    public static void main(String[] args) {
        ...
        //4. 만약 String이 특정 문자열로 끝나는 지 확인할 때에는
        //   endWith() 메소드를 실행하면 된다.
        System.out.println("str.endWith(\"아\"): "+str.endsWith("아"));
        System.out.println("str.endWith(\"가\"): "+str.endsWith("가"));
        ...
        //9. 해당 문자열의 길이가 알고싶을 때에는
        //   length()메소드를 실행하면 된다.
        str = "123456789";
        System.out.println("str.length(): "+str.length());
        
        //10. 해당 문자열의 특정 정규표현식의 따라서
        //    패턴이 맞는지를 체크할 때에는 matches()를 실행하면 된다.
        //    정규표현식이란? = 숙제
        String pattern = "\\d*"; // \\d*은 모든 문자가 숫자로 이루어졌는지를 확인함
        System.out.println("str.matches(pattern)"+str.matches(pattern));
        pattern = "\\w*"; // \\w*은 모든 문자가 알파벳과 숫자로 이루어졌는지를 확인함
        System.out.println("str.matches(pattern)"+str.matches(pattern));
        ...
        //    startWith()로 확인한다.
        System.out.println("str.startWith(\"1234\"): "+str.startsWith("1234"));
        System.out.println("str.startWith(\"abcd\"): "+str.startsWith("abcd"));
