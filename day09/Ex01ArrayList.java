...
public class Ex01ArrayList {
    public static void main(String[] args) {
        ...
        //지정할떄는 <>에 우리가 무슨 클래스의 모음이다! 를 지정해야하고
        //<>에는 클래스만 들어갈 수 있다!
        ...
        //요리한 wrapper클래스를 어레이리스트의 모음으로 지정하면 된다!
        ...
        //    get(index)
        //    get(index)의 return 타입은 당연히 리스트가 보여있는 클래스이다!
        ...
        //    contains() 메소드
        //    단, 동일한 객체가 아니더라도 equals() true가 나오는 객체가
        //    존재한다면, true가 나온다.
        ...
        //2. 해당 리스트에 특정 객체의 index가 알고 싶다면
        //   indexOf() 메소드
        //   단 해당 객체가 리스트에 존재하지 않으면 -1이 리턴된다.
        //   또한 동일한 객체가 아니더라도 equals() true가 나오는 객체가
